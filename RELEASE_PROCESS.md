...
- 注: `releases/latest` は「最も新しいリリース」を指します。リリースは
  バージョン順に作成してください。順序を崩すと自動更新が古いバージョンで
  止まります。
- 注: `releases/latest` は **prerelease / draft を除外**した最新の正規リリースを
  指します。prerelease としてリリースすると自動更新がそのバージョンを
  スキップします。
